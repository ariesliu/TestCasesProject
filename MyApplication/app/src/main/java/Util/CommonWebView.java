...
package com.example.yuanwei3_iri.myapplication.Util;
...
public class CommonWebView extends WebView {
    ...
    private static final String[] mFilterMethods = {
            "getClass", "hashCode", "notify", "notifyAll", "equals",
            "toString", "wait",
    };
    ...
    private void init(Context context) {
        // 删除掉Android默认注册的JS接口
        mJsInterfaceMap = getJsInterfaceMap();
        removeSearchBoxImpl();
    }

    private HashMap<String, Object> getJsInterfaceMap() {
        if (mJsInterfaceMap == null) {
            mJsInterfaceMap = new HashMap<String, Object>();
        }
        return mJsInterfaceMap;
    }
